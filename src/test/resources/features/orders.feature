@Orders
Feature: Login on OWASP juice-shop and add products to basket and do purchase
  ...
  Scenario: Login with user correct and add 3 products (Apple, Banana, T-shirt) to basket and do purchase
  ...
  Scenario: Login with user correct and add 2 products random to basket and do purchase
